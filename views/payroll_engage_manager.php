...
function calc(){
	...
	var daily_rate = parseFloat(document.getElementById("daily_rate").value);
	var absent1 = parseFloat(document.getElementById("absent1").value);
	var c2 = (daily_rate * absent1).toFixed(2);
	document.getElementById("absent").value = c2 ;
	var late1 = parseFloat(document.getElementById("late1").value);
	var c3 = ((daily_rate/8)*late1).toFixed(2);
	document.getElementById("late").value = c3 ;
	var c = (x * y).toFixed(2);
  ...
  var ccccccc = ((xxxxxxx * yyyyyyy)*.1).toFixed(2);
	...
	var output = y+textValue2+textValue3+textValue4+textValue5+textValue6+textValue7-c2-c3;
	...
	$("#sum1").html(sum1.toFixed(2));
	 $("#net_pay").html(net_pay.toFixed(2));
						...
						<form action="index.php?page=submit_payroll_manager"  method="POST" enctype="multipart/form-data">
...
<tr><th colspan='6' >
			...
			<tr><td colspan='6'> 
			NAME:<?php echo"$first_name";?></td></tr>
			<tr>
			<input type="hidden" name="name" value="<?php echo"$first_name";?>" maxlength="12" readonly> 
			<td colspan='6'>DAILY PAY : <?php 	$hourly_pay = round($daily_pay/8); echo"$daily_pay1";?></td></tr>
			<tr>
			<input type="hidden"  id="a" name="daily_pay" value="<?php echo"$hourly_pay";?>" maxlength="12" readonly>  
			<input type="hidden"  id="daily_rate" name='daily_pay'  value="<?php echo"$daily_pay1";?>" maxlength="12" readonly>  
			<td colspan='6'>MONTHLY PAY : <?php echo"$monthly_pay1";?></td></tr>
			<input type="hidden"  id="monthly_pay" name="monthly_pay" value="<?php echo"$monthly_pay";?>" maxlength="12" readonly> 
	
			<tr><td colspan='6'>LAST GROSS PAY: -----</td></tr>
...
$basicpay = round($monthly_pay/2,2);
$whole_pay=$ccc+$ddd+$eee+$fff+$ggg;
...
?>
	<tr>
	<td>Basic Pay</td>
	<td><input style="width:100px" id="b" onkeyup="multiply()" name="reg_hours"  type="number" step="0.01"  onkeydown="javascript: return event.keyCode == 69 ? false : true"  value="<?php echo"$basicpay";?>"  readonly></td>
	<td> SSS:</td>
	<td><input id='sss' name='sss' style="width:100px" type="number" step="0.01"  onkeydown="javascript: return event.keyCode == 69 ? false : true"   value='0'  readonly> </td>
	<td>Cola:</td>
	...
	<td>Pag-ibig:</td>
	<td><input id='pag_ibig' name='hdmf' type="number" id="pagibig" step="0.01"  onkeydown="javascript: return event.keyCode == 69 ? false : true"  style="width:100px" value='0'   readonly></td>
	...
	<td>Philhealth:</td>
	<td><input id='philhealth' name='phic' type="number" step="0.01"  onkeydown="javascript: return event.keyCode == 69 ? false : true"  style="width:100px"  value='0'   readonly></td>
	...
	<td>Tax:</td>
	<td><input id='tax' name='wh_tax'  type="number" step="0.01"  onkeydown="javascript: return event.keyCode == 69 ? false : true"  style="width:100px"  value='0'   readonly></td>
	...
	<tr>
	<td>Late:
	<input type="hidden" id="c" value='0' name='gross' class="gross" style="width:100px"  >
	...
	<input type="hidden" id="ccccc" value='0' name='gross' class="gross" style="width:100px"  >
	<input type="hidden" id="cccccc" value='0' name='gross' class="gross" style="width:100px"  >
	<input type="hidden" id="ccccccc" value='0' name='gross' class="gross" style="width:100px"  >
	
	</td>
	<td><input type="number" id="late1" step="0.01"  onkeydown="javascript: return event.keyCode == 69 ? false : true"  style="width:100px" name="late_charges" value='<?php echo"$aa";?>'  maxlength="12" readonly></td>
	<td>Salary Loan :  </td>
	...
	<tr>
	<td>Absent:	
	<input type="hidden" id="absent" value='0' name='gross' class="gross" style="width:100px"  >
	<input type="hidden" id="late" value='0' name='gross' class="gross" style="width:100px"  >
	</td>
	<td><input type="number" id="absent1" step="0.01"  onkeydown="javascript: return event.keyCode == 69 ? false : true"  style="width:100px" name="absent" value='<?php echo"$absent";?>'  maxlength="12" readonly></td>
