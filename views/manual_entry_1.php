       ...
       <form action=""  method="POST" enctype="multipart/form-data">
        ...
        <tbody><tr>
          ...
          <td align="left" bgcolor="#FFFFFF"><small> 
            ...
            <input name="datefrom" type="date" value='<?php echo"$datefrom";?>' style="border:solid 1px #333333; text-align:center" required> &nbsp;<strong> TO:</strong>&nbsp;
            <input name="dateto" width='100px' value='<?php echo"$dateto";?>' type="date"   style="border:solid 1px #333333; text-align:center;" required></td>
        </tr>
        <tr>
		  ...
		  <?php
			...
			echo"<option value='$employee_id'>$last_name1, $first_name1</option>";
          ...
          echo"<option value='$row[emp_id]'>$row[last_name], $row[first_name]</option>";
		   ...
		   echo'</select>';
		  ?>
            <input style="width:70px;height:30px;" type="submit"  value="ENTER"> &nbsp;&nbsp;&nbsp;<a style='width: 50%;
		...
		border: none;
		border-radius: 2px;
		cursor: pointer;' href='index.php?page=manual_encode'/>MANUAL ENTRY</a><br >
</td>
        </tr>
</tbody>
</form></table>
...
<table style="color:black"  width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#ffffff" valign="bottom" style="color:#333333 ">
    ...
    <th align="center" bgcolor="#ffffff"><small>LOCATION</small></th>
      <th height="1" align="center" bgcolor="#ffffff">&nbsp;<small>ACTION </small></th>
  </tr>  
 <?php
		
			$sql1 = "SELECT * FROM bio where emp_id='$employee_id' and date_bio between '$datefrom' and '$dateto' order by date_bio asc";
...
$dayOfWeek = date("l", $unixTimestamp);
  ...
  echo'<tr bgcolor="#ffffff" valign="bottom" style="color:#333333 ">
    ...
    <th align="center" bgcolor="#ffffff"><small>'.$location.'</small></th>
   <th align="center" bgcolor="#ffffff"><small> <a href="index.php?page=edit_manual_encode&ID='.$row1['id'].'">EDIT</a></small> | <small> <a href="index.php?page=delete_entry&ID='.$row1['id'].'">DELETE</a></small></th>
   </tr>';
			}
  ?>
  <tr bgcolor="#ffffff" valign="bottom" style="color:#333333 ">
