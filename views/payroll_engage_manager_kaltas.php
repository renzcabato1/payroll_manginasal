...
<tr><th colspan='6' >
			...
			<tr><td colspan='6'>LAST GROSS PAY: <?php echo"$gross_pay_manager";?></td></tr>
			<input type="hidden" name="last_pay"  value="<?php echo"$gross_pay_manager";?>" maxlength="12" readonly> 
			</td></tr>	<?php
...
$latest=round(($aa*$hourly_pay),2) ;
$abtes=round(($absent*$daily_pay),2) ;


$basicpay = round($monthly_pay/2,2);
$whole_pay=$ccc+$ddd+$eee+$fff+$ggg+$basicpay-$latest-$abtes+$gross_pay_manager;
