<div class="listing" style="color:black;">
		...
		<tr>
			...
			<td class="value"><?php
										...
										$sql = "SELECT * FROM information where emp_id='$name' ORDER BY first_name ASC";
...
echo"</tr>";
$sql5 = "SELECT * FROM information where account_type!='ADMIN' and emp_id='$name' ORDER BY first_name ASC";
