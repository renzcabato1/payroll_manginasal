...
<div class="listing" style="color:black;">
		...
		<tr>
			<td class="title">DAILY PAY :</td>
			<td class="value"><input type="text" name="daily_pay" value="<?php echo"$daily_pay";?>" maxlength="12" readonly> </td>
		</tr><tr>
			<td class="title">MONTHLY PAY :</td>
			<td class="value"><input type="text" name="monthly_pay" value="<?php echo"$monthly_pay";?>" maxlength="12" readonly> </td>
		</tr>
	...
	<tbody>
		...
		<tr>
			...
			<td class="value"><input type="text" name="absent" value="<?php echo"$absent";?>" maxlength="12" > </td>
		</tr>
		<tr>
